...
>4. Add Refresh Token functionality to easily issue new tokens after expiration.
>5. Middleware for exception handling and enforcing a standard such as [JSON Specification](https://jsonapi.org/format/). Currently any errors will be displayed in a non user friendly way.
>6. Would love to add more unit tests in the future. Maybe if there was more business logic involved.
>7. Add Bearer Token auth to the swagger page for easy testing.
...
>4. Thinking about errors and how they will be displayed in a non user friendly way, I think some of them even return a stack trace. That could reveal dangerous information.
